...
# Création de la route pour la vérification de l'état de l'API
...
# Création de la route pour l'envoie des feedback vers application insights
...
# Création d'un contexte d'exécution sur databricks
...
# Exécution des analyses de données sur databricks
